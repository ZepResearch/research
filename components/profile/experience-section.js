...
import { Briefcase, Plus, Edit3, Trash2, X, Save } from "lucide-react"
import { createExperience, updateExperience, deleteExperience } from "@/lib/pocketbase"
import { ExpandableText } from "./expandable-text"

export function ExperienceSection({ experiences = [], userId, onUpdate }) {
      ...
      <div className="p-6">
        ...
        {isAdding || editingId ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white disabled:opacity-50"
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            {experiences.map((exp) => (
              <div key={exp.id} className="pb-4 border-b border-gray-200 dark:border-gray-700 last:border-b-0 last:pb-0">
          ...
          <p className="text-gray-500 dark:text-gray-400">No experience yet</p>
        )}
      </div>
    </div>
  )
