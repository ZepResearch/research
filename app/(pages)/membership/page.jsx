...
import { CtaAccessCard } from "@/components/membership/CtaAccessCard";
        ...
        <div className="max-w-[960px] mx-auto px-6 py-12">
          ...
          {checking ? (
            ...
            <>
              <div className="grid grid-cols-2 gap-8 mb-14 items-start">
                <div className="flex flex-col gap-4">
                  ...
                  {/* CtaAccessCard — unlocked for active members */}
                  <CtaAccessCard isMember={true} />
                </div>
                <CardSection />
              </div>
            ...
            <>
              <div className="grid grid-cols-2 gap-8 mb-14 items-start">
                <div className="flex flex-col gap-4">
                  ...
                  {/* CtaAccessCard — locked for expired members */}
                  <CtaAccessCard isMember={false} />
                </div>
            ...
            <>
              <div className="grid grid-cols-2 gap-8 mb-14 items-start">
                <div className="flex flex-col gap-4">
                  {/* CtaAccessCard — locked for non-members */}
                  <CtaAccessCard isMember={false} />
                </div>
                <CardSection />
              </div>
