...
import { getJournals, searchJournals } from "@/lib/pocketbase"
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto mt-12">
        <div className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Explore and discover academic journals and submit your research papers.</p>
          ...
          <div className="flex flex-col gap-4 mb-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4">
              ...
              <div className="flex items-end justify-center">
               ...
               {/* <div className="flex items-end">
                <Button onClick={() => router.push("/journals/my-submission")} variant="outline">
